...
const ContactCTA: React.FC = () => {
  ...
  return (
    <section className="py-24 px-4">
      <div className="max-w-6xl mx-auto bg-[#001F3F] rounded-[3rem] p-12 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
        {/* Background elements */}
        ...
        <div className="relative z-10 space-y-10">
          <h2 className="text-4xl md:text-6xl font-black leading-tight tracking-tighter text-white">
